...
# На вход программе подаётся два целых числа: количество школьников
# и количество мандаринов, каждое на отдельной строке.
#
...
num_s, num_m = int(input()), int(input())
print(num_m // num_s, num_m % num_s, sep='\n')
